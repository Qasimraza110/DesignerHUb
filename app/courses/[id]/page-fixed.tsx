...
export default function CourseDetailPage({ params }: CourseDetailPageProps) {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-r from-purple-300 via-pink-300 to-red-300 py-12">
          ...
          <div className="space-y-8">
            {roadmap.map((week, idx) => (
              <motion.div
                ...
                className="bg-gradient-to-r from-purple-100 via-pink-100 to-red-100 rounded-2xl p-6 shadow-lg hover:shadow-2xl transition-all"
              >
                <div className="flex flex-col sm:flex-row sm:items-center mb-4">
                  <div className="w-12 h-12 flex items-center justify-center rounded-full bg-blue-600 text-white font-bold text-lg sm:mr-6 mb-3 sm:mb-0">
                    {week.week}
                  </div>
